  ...
  return (
    <section className="">
      ...
      <div className="text-center py-10">
        ...
        <h3 className="text-3xl py-2 md:text-1xl hover:animate-bounce dark:text-[#ffffff]">
      ...
      <div className="text-5xl flex justify-center gap-16 PY-3 text-gray-600 dark:text-gray-300">
        <a
          ...
          className="hover:text-[#595CFF] text-[#202223] dark:text-[#ffffff] dark:hover:text-[#595CFF]"
        >
          <AiFillLinkedin />
        </a>
        <a
      ...
      <div className="flex flex-col justify-center items-center py-10 leading-8">
        <button className="">
          <a
            className="bg-gradient-to-r from-[#595CFF] to-[#C6F8FF] hover:bg-cyan-600 text-[#ffffff] px-10 py-3.5 rounded-md font-nikea text-lg border-0 shadow-lg overflow-hidden transition duration-100 transform hover:bg-gray-100 hover:shadow-md"
            href="#"
          >
            Contact me
          </a>
