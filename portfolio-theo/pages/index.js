      ...
      <main className="px-10 md:px-20 lg:px-40 dark:bg-[#121212f0] dark:text-white py-10">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <h3 className="py-2 md:text-1xl hover:animate-bounce text-[#202223]">Front End Web Developer</h3>
          ...
          <div className="text-5xl flex justify-center gap-16 PY-3 text-gray-600 dark:text-gray-300">
            <a href="https://www.linkedin.com/in/theodaudebourg" className="hover:text-[#595CFF] text-[#202223]"><AiFillLinkedin /></a>
            <a href="https://www.youtube.com/channel/UChH_oneD9OKdCK-ChHFz-2w" className="hover:text-[#595CFF] text-[#202223] "><AiFillYoutube /></a>
          </div>
      ...
      <p className="py-1">Node JS & MySQL, Liquid</p>
        ...
        <section>
          <div className="text-center py-20">
            <h3 className="text-3xl py-1 text-[#595CFF] ">Portfolio</h3>
          ...
          <div className="basis-1/3 flex-1">
                    ...
                    <div className="absolute inset-x-0 top-0 bottom-0 flex items-center justify-center">
                      <div className="text-center p-4 bg-transparent transition-all duration-500 opacity-0 hover:opacity-100 hover:bg-[#000000eb] hover:dark:bg-[#212121] rounded-lg md:w-full md:h-full md:rounded-lg sm:h-screen flex flex-col items-center justify-center">
                        ...
                        <p className="text-[#202223] dark:text-white">
                        ...
                        <ul className="pt-5 ">
                          <li>
                            ...
                            <p className="text-[#202223]">Liquid, Ajax, Javascript, Shopify </p>
                          </li>
...
<footer className="pt-5 dark:bg-[#121212f0] dark:text-white py-10">
    <div className="mx-auto w-full container p-4 sm:p-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                  <span className="self-center text-2xl font-nikea whitespace-nowrap text-[#202223] dark:text-white">Theo Daudebourg</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-[#202223] uppercase dark:text-white">Follow me</h2>
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-[#202223] uppercase dark:text-white">Legal</h2>
                  <ul className="text-[#202223] dark:text-gray-400">
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-[#202223] sm:text-center dark:text-gray-400">© 2023 <a href="https://theodaudebourg.vercel.app" className="hover:underline">Theo Daudebourg</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="https://github.com/LilZloty" className="text-[#202223] hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="https://www.linkedin.com/in/theodaudebourg" className="hover:text-[#595CFF] text-[#202223]">
